...
class PuntoMarker extends Marker {
  ...
  PuntoMarker({
    ...
    child: _wid(context, avistamiento, preView),
    width: width,
    height: height,
    alignment: alignment,
    rotate: rotate,
  ...
  static Widget _wid(BuildContext context, ClsAvistamiento avistamiento, Widget preView) {
    return Container(
      child: Stack(
        children: [
          Positioned(
          ...
          Positioned(
              ...
              child: Container(
                  ...
                  child: InkWell(
                    ...
                    child: ClipOval(
                      child: preView,//Util.viewPhoto(avistamiento.rutaFoto),
                    ),
                  )
              )
          ),
